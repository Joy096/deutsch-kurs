...
const WBDATA=[
  // ── Im Kursraum — фото 1, левый столбик ──────────────────────────────────────
  ...
  // ── Im Kursraum — фото 1, правый столбик (школьные) ──────────────────────────
  ...
  // ── Alltag — фото 1, правый столбик (повседневные) ───────────────────────────
  ...
  {art:"das",de:"Foto",          pl:"Fotos",           ru:"фото, фотография",       tema:"Alltag"},
  // ── Möbel — фото 2, левый столбик ────────────────────────────────────────────
  ...
  {art:"die",de:"Mikrowelle",    pl:"Mikrowellen",     ru:"микроволновка",          tema:"Möbel"},
  ...
  {art:"die",de:"Miete",         pl:"Mieten",          ru:"аренда, квартплата",     tema:"Wohnung"},
  {art:"die",de:"Nebenkosten",   pl:"Nebenkosten",     ru:"коммунальные платежи",   tema:"Wohnung"},
  {art:"das",de:"Erdgeschoss",   pl:"Erdgeschosse",    ru:"0-й этаж (цоколь)",      tema:"Wohnung"},
  ...
  {art:"die",de:"Einbauküche",   pl:"Einbauküchen",     ru:"встроенная кухня (EBK)", tema:"Wohnung"},
  {art:"die",de:"Lage",          pl:"Lagen",            ru:"расположение, местоположение",tema:"Wohnung"},
  {art:"die",de:"Warmmiete",     pl:"Warmmieten",       ru:"аренда всё включено",    tema:"Wohnung"},
  {art:"die",de:"Vermietung",    pl:"Vermietungen",     ru:"сдача в аренду",         tema:"Wohnung"},
  {art:"das",de:"Mietgesuch",    pl:"Mietgesuche",      ru:"поиск аренды",           tema:"Wohnung"},
  {art:"der",de:"Garten",        pl:"Gärten",           ru:"сад",                    tema:"Wohnung"},
  {art:"die",de:"Nähe",          pl:"—",                ru:"близость, окрестности",  tema:"Wohnung"},
  // ── Фразы / Wendungen ────────────────────────────────────────────────────────
  {art:"",de:"in der Nähe von",  pl:"—",                ru:"рядом с, вблизи от",      tema:"Phrase"},
  // ── Adjektive — из учебника ───────────────────────────────────────────────────
  ...
  // ── Hotel & Reise ─────────────────────────────────────────────────────────────
  {art:"das",de:"Hotel",         pl:"Hotels",          ru:"отель, гостиница",       tema:"Reise"},
  {art:"das",de:"Doppelzimmer",  pl:"Doppelzimmer",    ru:"двухместный номер",      tema:"Reise"},
  {art:"das",de:"Einzelzimmer",  pl:"Einzelzimmer",    ru:"одноместный номер",      tema:"Reise"},
  {art:"der",de:"Urlaub",        pl:"Urlaube",         ru:"отпуск, каникулы",       tema:"Reise"},
  {art:"die",de:"Nacht",         pl:"Nächte",          ru:"ночь",                   tema:"Reise"},
  // ── Adresse & Kontakt ─────────────────────────────────────────────────────────
  {art:"die",de:"Straße",        pl:"Straßen",         ru:"улица",                  tema:"Adresse"},
  {art:"die",de:"Hausnummer",    pl:"Hausnummern",     ru:"номер дома",             tema:"Adresse"},
  {art:"die",de:"Postleitzahl",  pl:"Postleitzahlen",  ru:"почтовый индекс",        tema:"Adresse"},
  {art:"die",de:"Telefonnummer", pl:"Telefonnummern",  ru:"номер телефона",         tema:"Adresse"},
  {art:"die",de:"Handynummer",   pl:"Handynummern",    ru:"номер мобильного",       tema:"Adresse"},
  {art:"die",de:"Vorwahl",       pl:"Vorwahlen",       ru:"код города",             tema:"Adresse"},
  {art:"die",de:"E-Mail-Adresse",pl:"E-Mail-Adressen", ru:"эл. почта",              tema:"Adresse"},
  {art:"der",de:"Vorname",       pl:"Vornamen",        ru:"имя",                    tema:"Adresse"},
  {art:"der",de:"Familienname",  pl:"Familiennamen",   ru:"фамилия",                tema:"Adresse"},
  {art:"der",de:"Nachname",      pl:"Nachnamen",       ru:"фамилия (разг.)",        tema:"Adresse"},
  // ── Adjektive ─────────────────────────────────────────────────────────────────
...
function Woerterbuch(){
  ...
  const WRow=({w})=>{
    ...
    return(
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:4,
        ...
        <div style={{fontSize:12,color:C.muted,lineHeight:1.3,overflowWrap:"break-word",wordBreak:"break-word"}}>{w.ru}</div>
      </div>
    );
  };
  ...
  return(
    <div>
      ...
      {/* ── Фильтр по теме (скрываем ненужные) ── */}
        ...
        {groups.map(g=>(
          <div key={g.id} style={{background:C.card,border:`1px solid ${g.col}35`,borderRadius:12,overflow:"hidden"}}>
            ...
            {g.id==="Adjektive"&&!search
              ...
              :g.words.map((w,i)=><WRow key={w.de+w.tema+i} w={w}/>)
            }
          </div>
        ))}
      </div>
